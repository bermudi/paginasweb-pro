    ...
    >
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <motion.div className="grid grid-cols-3 sm:grid-cols-3 gap-2 sm:gap-3 md:gap-4 mt-8">
            <motion.button
              type="submit"
              disabled={isSubmitting}
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              className="col-span-3 sm:col-span-1 bg-black text-white px-4 py-3 rounded-lg font-medium flex items-center justify-center gap-2 hover:bg-black/90 transition-all text-sm sm:text-base"
            >
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              className="col-span-1 sm:col-span-1 bg-green-500 text-white p-3 rounded-lg font-medium flex items-center justify-center gap-2 hover:bg-green-600 transition-all"
            >
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              className="col-span-1 sm:col-span-1 bg-blue-500 text-white p-3 rounded-lg font-medium flex items-center justify-center gap-2 hover:bg-blue-600 transition-all"
            >
