    ...
    <section className="py-20 bg-gradient-to-b from-white to-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          className="mb-20"
        >
          <div className="relative h-80 bg-gradient-to-r from-blue-100 via-purple-50 to-pink-100 rounded-3xl overflow-hidden shadow-2xl">
            <style>
              {`
                .advancing-car {
                  animation: advance 8s ease-in-out infinite;
                }
                @keyframes advance {
                ...
                @keyframes shadow-scale {
                  ...
                  50% { transform: scaleX(0.8) scaleY(0.6); opacity: 0.15; }
                }

                .wheel-spin {
                  animation: wheel-rotation 0.8s linear infinite;
                ...
                @keyframes smoke-puff {
                  ...
                  100% { transform: translateX(-30px) translateY(-20px) scale(2); opacity: 0; }
                }
            ...
            {/* Exhaust Smoke */}
            <div className="absolute bottom-24 left-1/2 transform -translate-x-1/2 translate-x-8">
              <div className="exhaust-smoke w-3 h-3 bg-gray-400 rounded-full" style={{ animationDelay: '0s' }}></div>
              <div className="exhaust-smoke w-2 h-2 bg-gray-300 rounded-full absolute top-1 left-2" style={{ animationDelay: '0.5s' }}></div>
              <div className="exhaust-smoke w-2 h-2 bg-gray-200 rounded-full absolute top-2 left-4" style={{ animationDelay: '1s' }}></div>
            </div>

            <svg
              className="advancing-car absolute bottom-0 left-1/2 transform -translate-x-1/2"
              width="320"
              height="200"
              viewBox="0 0 800 600"
            >
              {/* Car Shadow */}
              <ellipse className="car-shadow" fill="#000" cx="400" cy="480" rx="180" ry="15" />

              <g className="car-bounce">
                {/* Car Body */}
                <rect x="250" y="350" width="300" height="80" rx="15" fill="#3B82F6" />
                <rect x="280" y="320" width="240" height="50" rx="20" fill="#1E40AF" />

                {/* Car Details */}
                <rect x="300" y="330" width="60" height="30" rx="5" fill="#E5E7EB" />
                <rect x="380" y="330" width="60" height="30" rx="5" fill="#E5E7EB" />
                <rect x="460" y="330" width="60" height="30" rx="5" fill="#E5E7EB" />

                {/* Headlights */}
                <circle cx="240" cy="370" r="12" fill="#FEF3C7" className="opacity-90" />
                <circle cx="560" cy="370" r="12" fill="#FEF3C7" className="opacity-90" />

                {/* Side Details */}
                <rect x="570" y="360" width="25" height="15" rx="3" fill="#9CA3AF" />
                <rect x="205" y="360" width="25" height="15" rx="3" fill="#9CA3AF" />

                {/* Wheels */}
                <g>
                  <circle cx="300" cy="450" r="35" fill="#374151" />
                  <circle cx="300" cy="450" r="20" fill="#6B7280" className="wheel-spin" />
                  <circle cx="300" cy="450" r="8" fill="#9CA3AF" />
                </g>

                <g>
                  <circle cx="500" cy="450" r="35" fill="#374151" />
                  <circle cx="500" cy="450" r="20" fill="#6B7280" className="wheel-spin" />
                  <circle cx="500" cy="450" r="8" fill="#9CA3AF" />
                </g>
              </g>
            </svg>
          </div>
