            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
              ...
              <div className="van-container relative h-64 overflow-hidden rounded-lg bg-gradient-to-b from-sky-200 to-sky-100">
                <style>
                  {`
                    .van-body {
                      animation: van-drive 1s ease-in-out infinite;
                    }
                    @keyframes van-drive {
                    ...
                    .van-main {
                       animation: van-move 12s ease-in-out infinite;
                    }
                    @keyframes van-move {
                    ...
                    @keyframes sway {
                      from { transform: rotate(-1.5deg) translateX(-2px); }
                      to { transform: rotate(1.5deg) translateX(2px); }
                    }
                  `}
                </style>
